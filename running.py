...
# def pace(pace_per_h):
#     integer = pace_per_h.astype('int64')
#     # integer = int(pace_per_h)
#     dez = pace_per_h - integer
#     dez_time = dez * 0.6
#     pace_per_min = (integer + dez_time).round(2)
#     return pace_per_min
...
df = pd.read_excel("Laufdaten.xlsx", index_col=0, parse_dates=True)
